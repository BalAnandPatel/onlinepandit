                                        ...
                                        <div class="elementor-element elementor-element-47e16f3 ha-card--top ha-card--tablet-top ha-card--mobile-top elementor-widget elementor-widget-ha-card happy-addon ha-card" data-id="47e16f3" data-element_type="widget" data-widget_type="ha-card.default">
                                            <div class="elementor-widget-container">
                                                <figure class="ha-card-figure">
                                                    <img width="800" height="600" src="admin/image/event/<?=$value1->image;?>" class="attachment-large size-large wp-image-953" alt="" />
                                                </figure>
                                                <div class="ha-card-body">
                                                    <h2 class="ha-card-title"><?php echo $value1->name; ?></h2>
                                                    <p><?php echo $value1->description ; ?></p>
                                                    <a class="ha-btn" href="booknow.php"><span class="ha-btn-text">Book Puja</span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
