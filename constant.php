...
$URL="http://localhost/onlinepandit/api/src/";
$ADMIN_IMG_PATH="http://localhost/onlinepandit/user/img/";
$GALLERY_IMG_PATH="http://localhost/onlinepandit/admin/image/gallery/";
$GALLERY_VIDEO_PATH="http://localhost/onlinepandit/admin/uploads/videos/";
$GALLERY_NEWS_PATH="http://localhost/onlinepandit/admin/uploads/news/";
